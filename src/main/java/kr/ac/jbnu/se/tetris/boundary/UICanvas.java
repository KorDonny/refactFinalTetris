...
import static kr.ac.jbnu.se.tetris.boundary.CanvasScoreInterface.player1Score;
import static kr.ac.jbnu.se.tetris.boundary.CanvasScoreInterface.player2Score;
...
public class UICanvas extends JPanel{
    ...
    public UICanvas() throws IOException {
        ...
        if(!(this instanceof TetrisCanvas)){
            BackPanel.addTask(uiCanvasWorks, new TimerTask() {
            @Override
            public void run() {
                repaint();
            }
